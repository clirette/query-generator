...
const updatedPurposeInput = document.getElementById('updated-purpose-input');
const newNormalInput = document.getElementById('new-normal-input');
const newDiscoveriesInput = document.getElementById('new-discoveries-input');
const initialChallengesInput = document.getElementById('initial-challenges-input');
...
const updatedPurposeTemplate = document.getElementById('updated-purpose-template');
const newNormalTemplate = document.getElementById('new-normal-template');
const newDiscoveriesTemplate = document.getElementById('new-discoveries-template');
const initialChallengesTemplate = document.getElementById('initial-challenges-template');
...
function updateTemplate(e) {
  ...
  updatedPurposeTemplate.innerText = updatedPurposeInput.value;
  newNormalTemplate.innerText = newNormalInput.value;
  newDiscoveriesTemplate.innerText = newDiscoveriesInput.value;
  initialChallengesTemplate.innerText = initialChallengesInput.value;
